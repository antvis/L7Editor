...
const amaplayerInfo = [
  {
    type: 'Satellite',
    title: '卫星图',
    image: 'https://mdn.alipayobjects.com/huamei_rzapb5/afts/img/A*cet9T5Nh9eIAAAAAAAAAAAAADqWCAQ/original',
  },
  {
    type: 'RoadNet',
    title: '路网图',
    image: 'https://mdn.alipayobjects.com/huamei_rzapb5/afts/img/A*G9RtT7qUxwYAAAAAAAAAAAAADqWCAQ/original',
  },
  {
    type: 'Traffic',
    title: '路况图',
    image: 'https://mdn.alipayobjects.com/huamei_rzapb5/afts/img/A*XTFITYbZaIsAAAAAAAAAAAAADqWCAQ/original',
  },
  {
    type: 'Buildings',
    title: '楼块图',
    image: 'https://mdn.alipayobjects.com/huamei_rzapb5/afts/img/A*hIUgTryh-oAAAAAAAAAAAAAADqWCAQ/original',
  }
]
...
export function AmapLayerControl() {
  ...
  useEffect(() => {
    if (scene) {
      ...
      isIncludes('Satellite') ? amapAdd.add(satellite) : amapAdd.remove(satellite)
      ...
      isIncludes('Buildings') ? amapAdd.add(buildings) : amapAdd.remove(buildings)
        ...
        {amaplayerInfo.map((item) => {
          return (
            <div key={item.type}
              ...
              style={{
                border: layerType.includes(item.type) ? '1px solid #1677ff' : 'none'
              }}
            >
